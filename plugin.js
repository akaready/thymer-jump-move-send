  ...
  var Plugin = class extends AppPlugin {
    ...
    onLoad() {
      ...
      void healPluginIdentity(this, {
        name: "Jump Move Send",
        icon: "calendar-event",
        description: "Jump to, move to, or send to any journal day.",
        sourceRepo: "https://github.com/akaready/thymer-jump-move-send",
      ...
      this._panelEl.replaceChildren(panel({ pluginClass: ROOT_CLASS + "-panel" }, [
        pluginHeaderFromConfig(conf, {
          ...
          killSwitch: {
            ...
            onToggle: /* @__PURE__ */ __name((nextOn) => void this._settingsStore.setDisabled(!nextOn), "onToggle")
          },
